...
const RECENT_CHANGES = [
  { version: '3.112.0', date: '2026-08-19', groups: [{ label: '추가', items: ['설정을 바꾸면 드라이브의 설정 백업이 자동으로 갱신돼요 — 드라이브가 연결돼 있으면 설정 변경 후 3초 뒤 백업 파일(BrainBloom_settings.json)이 최신으로 유지됩니다. 원치 않으면 설정 → 저장·드라이브의 "설정 자동 백업"을 끄면 기존처럼 버튼으로만 저장돼요. 불러오기는 항상 수동이라 다른 컴퓨터의 설정을 마음대로 덮지 않습니다.'] }] },
